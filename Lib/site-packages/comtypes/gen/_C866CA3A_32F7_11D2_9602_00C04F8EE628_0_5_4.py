...
__all__ = [
    ...
    'SVP_11', 'DISPID_SpeechAudioBufferInfo', 'SPCS_DISABLED',
    'SPCS_ENABLED', 'DISPID_SPAStartElementInResult',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SVGetAudioOutputs',
    'SpeechTokenKeyAttributes', 'SPPHRASE', 'ISpeechRecognizer',
    'SDA_Consume_Leading_Spaces', 'SVEStartInputStream', 'SVP_0',
    'SREAudioLevel', 'SPINTERFERENCE', 'SVP_1',
    'DISPID_SVSpeakStream', 'SPEVENTSOURCEINFO', 'DISPID_SPRulesItem',
    'DISPID_SPRuleParent', 'DISPID_SOTIsUISupported',
    'SAFTCCITT_uLaw_44kHzStereo', 'SRTReSent',
    'SpeechCategoryAppLexicons', 'DISPID_SVEStreamStart', 'SVP_21',
    'SpeechTokenValueCLSID', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPCIdToPhone', 'SVP_18', 'SPFM_OPEN_READWRITE',
    'DISPID_SRRAudio', 'DISPID_SRGId', 'STCAll',
    'DISPID_SRRAudioFormat', 'DISPID_SPPs_NewEnum',
    'SDTPronunciation', 'SGLexicalNoSpecialChars',
    'DISPID_SGRAttributes', 'SVEViseme', 'DISPID_SRCRequestedUIType',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPEI_MIN_TTS',
    'SPINTERFERENCE_NOISE', 'DISPID_SPEs_NewEnum', 'SWTAdded',
    'SVP_5', 'DISPID_SPIAudioSizeTime', 'DISPID_SRCEAdaptation',
    'SINoise', 'DISPID_SADefaultFormat', 'SAFTText',
    'DISPID_SPEDisplayText', 'DISPID_SPRsItem', 'DISPID_SVResume',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SREStreamEnd',
    'SPXRO_Alternates_SML', 'DISPID_SpeechPhoneConverter',
    'SpeechSpecialTransitionType', 'DISPID_SRCEAudioLevel',
    'SAFT32kHz8BitStereo', 'SVP_17', 'SpeechRegistryLocalMachineRoot',
    'SAFT16kHz8BitMono', 'SGDSActiveUserDelimited', 'SVSFIsNotXML',
    'DISPID_SRState', 'SpSharedRecoContext', 'SPWAVEFORMATTYPE',
    ...
    'SPAR_Unknown', 'DISPID_SRCResume', 'SpeechLexiconType',
    'SDKLCurrentConfig', 'DISPID_SPACommit', 'DISPID_SPAPhraseInfo',
    'SVSFlagsAsync', 'IInternetSecurityManager', 'ISpeechAudioStatus',
    'ISpeechRecoResultDispatch', 'SPPS_RESERVED1',
    ...
    'DISPID_SVSVisemeId', 'SPWT_LEXICAL', 'SpeechAudioFormatGUIDWave',
    'DISPID_SABufferInfo', 'SpeechRecoContextState',
    'SAFT8kHz8BitStereo', 'eLEXTYPE_PRIVATE12',
    ...
    'DISPID_SVStatus', 'ISpeechPhraseReplacements', 'SP_VISEME_5',
    'SDTDisplayText', 'eLEXTYPE_PRIVATE14', 'Speech_Max_Pron_Length',
    'SPEI_VISEME', 'DISPID_SRCAudioInInterferenceStatus', 'SPSVerb',
    'SpeechDataKeyLocation', 'DISPID_SGRAddState',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPANumberOfElementsInResult',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SASCurrentDevicePosition',
    'SINone', 'DISPID_SRRTTickCount', 'SAFT16kHz8BitStereo',
    'SAFT32kHz8BitMono', 'DISPID_SPRulesCount', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRCState', 'SITooSlow', 'SPINTERFERENCE_NOSIGNAL',
    'ISequentialStream', 'SPEI_SR_PRIVATE', 'DISPID_SVEPhoneme',
    'SPADAPTATIONRELEVANCE', 'SPGRAMMARSTATE', 'SpeechUserTraining',
    'ISpeechMemoryStream', 'IInternetSecurityMgrSite',
    'DISPID_SAStatus', 'DISPID_SMSAMMHandle', 'SPWT_DISPLAY',
    'SRSActive', 'DISPID_SPIRule', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRRecognizer', 'SVSFVoiceMask',
    ...
    'SPWF_INPUT', 'SpeechVoiceEvents', 'DISPID_SDKCreateKey',
    'DISPID_SMSADeviceId', 'DISPID_SOTCSetId',
    'DISPID_SpeechPhraseProperties', 'SDTReplacement',
    'ISpeechGrammarRule', 'ISpeechRecoResult2', 'ISpResourceManager',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechInterference',
    'DISPID_SGRSTType', 'SAFTDefault', 'SPEI_SR_BOOKMARK',
    'eLEXTYPE_RESERVED6', 'SVESentenceBoundary', 'SVEPrivate',
    'SAFTCCITT_uLaw_22kHzMono', 'SPAUDIOSTATUS', 'eLEXTYPE_PRIVATE6',
    'SVP_10', 'SASRun', 'SAFTNonStandardFormat',
    'DISPID_SRCEInterference', 'DISPID_SVESentenceBoundary',
    'SpeechAudioProperties',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpCustomStream',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_PRIVATE10',
    'SAFT24kHz16BitMono', 'SPPARTOFSPEECH', 'SVSFPersistXML',
    'SRESoundStart', 'ISpSerializeState', 'SpWaveFormatEx',
    'ISpeechPhraseRule', 'DISPID_SWFEAvgBytesPerSec',
    'SSSPTRelativeToEnd', 'DISPID_SGRSAddWordTransition',
    'eLEXTYPE_PRIVATE2', 'SVSFNLPSpeakPunc', 'Speech_Default_Weight',
    'DISPID_SDKDeleteValue', 'SPCATEGORYTYPE', 'SVSFIsFilename',
    'SpeechVoiceSpeakFlags', 'ISpEventSink', 'SP_VISEME_19',
    'SpeechEngineConfidence', 'DISPID_SpeechPhraseAlternates',
    'SPEI_PHONEME', 'eLEXTYPE_PRIVATE11',
    'DISPID_SPRuleNumberOfElements', 'SpCompressedLexicon',
    'SWPUnknownWordUnpronounceable', 'SGSDisabled', 'SVP_4',
    'DISPID_SPEEngineConfidence',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpObjectToken',
    'DISPID_SWFEBlockAlign', 'DISPID_SOTCGetDataKey',
    'SAFT12kHz8BitStereo', 'SpeechGrammarRuleStateTransitionType',
    'SVP_16', 'SPAS_STOP', 'DISPID_SVGetVoices', 'DISPID_SGRName',
    'DISPID_SLGenerationId', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPAsCount',
    'SPEI_RESERVED6', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SABIBufferSize', 'SPSHORTCUTPAIRLIST',
    'SPPS_NotOverriden', 'SPRST_ACTIVE_ALWAYS',
    ...
    'SpInProcRecoContext', 'ISpPhrase', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRRTStreamTime', 'SPPS_Noncontent', 'ISpRecoResult',
    'SWTDeleted', 'eLEXTYPE_PRIVATE19', 'SPSFunction', 'SP_VISEME_14',
    'DISPID_SLWsItem', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SVAudioOutputStream', 'SpeechCategoryAudioOut',
    ...
    'Speech_StreamPos_Asap', 'DISPID_SPPName', 'SVSFDefault',
    'SPEI_RESERVED2', 'DISPID_SPPConfidence', 'SP_VISEME_18',
    'DISPID_SLWType', 'SGRSTTEpsilon', 'DISPID_SVVolume',
    'DISPID_SRRAlternates', 'SGRSTTRule',
    'ISpeechObjectTokenCategory', 'SRTSMLTimeout',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_UNDEFINED', 'eLEXTYPE_RESERVED9',
    'SPEI_END_INPUT_STREAM', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpPhoneticAlphabetConverter', 'SPCT_DICTATION', 'IStream',
    'SRARoot', 'ISpeechResourceLoader', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPRs_NewEnum', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechLexiconProns', 'SPEI_VOICE_CHANGE',
    'DISPID_SOTGetDescription', 'DISPID_SRDisplayUI',
    'DISPID_SAFGuid', 'DISPID_SVSInputWordPosition',
    'DISPID_SGRInitialState', 'SRCS_Enabled', 'SpPhraseInfoBuilder',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPCT_SUB_COMMAND',
    'SPAS_PAUSE', 'DISPID_SPEAudioSizeTime', 'SPFM_NUM_MODES',
    'DISPID_SLRemovePronunciation', 'SAFTCCITT_ALaw_8kHzMono',
    'SLTApp', 'SDKLCurrentUser', 'DISPID_SDKOpenKey', 'ISpPhraseAlt',
    'DISPID_SRGetPropertyNumber', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPRText', 'SPDKL_CurrentConfig', 'SAFTNoAssignedFormat',
    'ISpObjectToken', 'SPEI_FALSE_RECOGNITION', 'eLEXTYPE_PRIVATE17',
    'SPWORDPRONUNCIATION', 'DISPID_SOTCId', 'ISpeechBaseStream',
    'SpeechCategoryRecoProfiles', 'DISPID_SPILanguageId', 'SVP_13',
    'SAFT48kHz8BitStereo', 'DISPID_SRGCmdLoadFromFile', 'SPSLMA',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPSSuppressWord',
    'SPSERIALIZEDPHRASE', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SVEEnginePrivate', 'SPRST_INACTIVE', 'ISpDataKey',
    'DISPID_SOTId', 'DISPID_SRGCmdSetRuleIdState', 'ISpeechLexicon',
    'DISPID_SGRsCount', 'DISPID_SOTRemove', 'SPEI_SOUND_START',
    'DISPID_SFSOpen', 'SVF_None', 'SAFTADPCM_8kHzMono', 'SASClosed',
    'SAFT11kHz8BitMono', 'SECFIgnoreCase', 'SVEAllEvents',
    'DISPID_SGRsCommit', 'SPAUDIOSTATE',
    'SpeechPropertyComplexResponseSpeed', 'SPPS_Verb',
    'DISPID_SRCVoice', 'SP_VISEME_12', 'DISPID_SFSClose',
    'DISPID_SpeechRecognizer', 'SpLexicon', 'SP_VISEME_9',
    'DISPID_SOTCategory', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPPFirstElement', 'SP_VISEME_7', 'DISPID_SASState',
    'SDA_One_Trailing_Space', 'SAFT22kHz16BitStereo',
    'SGRSTTTextBuffer', 'SVPNormal', 'SAFTADPCM_22kHzStereo',
    'SVP_20', 'SAFT24kHz8BitMono', 'ISpNotifySink',
    'SPSERIALIZEDRESULT', 'SPEI_MAX_TTS', 'SREAllEvents', 'SVP_2',
    'DISPID_SGRSAddSpecialTransition', 'SSFMOpenForRead', 'SRAONone',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPEI_RESERVED3',
    'SAFTExtendedAudioFormat', 'ISpVoice',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechPhraseElement', 'DISPID_SPIGetText',
    'DISPID_SpeechLexiconWords', 'DISPID_SMSGetData',
    'SpeechGrammarTagUnlimitedDictation', 'SPVPRI_ALERT',
    'SPPS_RESERVED2', 'SPCT_SLEEP', 'eLEXTYPE_APP', 'SPSHORTCUTTYPE',
    'DISPID_SVWaitUntilDone', 'DISPID_SRAudioInputStream',
    'SPEI_PHRASE_START', 'LONG_PTR', 'ISpGrammarBuilder',
    'DISPID_SpeechObjectTokens', 'SpeechAudioState',
    'DISPID_SGRSTRule', 'SPWF_SRENGINE', 'SpeechRecognizerState',
    'DISPID_SRRSpeakAudio', 'DISPID_SPIEnginePrivateData',
    'DISPID_SVSpeak', 'SAFT16kHz16BitMono', 'SGDSActive',
    'DISPID_SASFreeBufferSpace', 'ISpeechGrammarRules',
    'ISpeechVoiceStatus', 'DISPID_SPIGrammarId',
    'DISPID_SVAlertBoundary', 'DISPID_SOTCreateInstance', 'SPRULE',
    'SVEWordBoundary', 'SpeechWordType', 'SPTEXTSELECTIONINFO',
    'SPAO_NONE', 'DISPID_SRGetPropertyString', 'SpSharedRecognizer',
    'DISPID_SPRuleConfidence', 'SPDKL_LocalMachine',
    'SGPronounciation', 'DISPID_SVSCurrentStreamNumber',
    'SPSHT_NotOverriden', 'DISPID_SpeechGrammarRules',
    'ISpeechObjectToken', 'SPWORD', 'SPFM_CREATE', 'SPLO_STATIC',
    'DISPID_SOTsItem', 'DISPID_SGRsItem', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRAddResource', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechVoiceStatus', 'SpeechLoadOption',
    'DISPID_SGRSTNextState', 'SWPUnknownWordPronounceable',
    'ISpeechDataKey', 'DISPID_SVIsUISupported',
    'SpeechWordPronounceable', 'DISPID_SPIEngineId',
    'DISPID_SRCPause', 'SREAdaptation', 'SpeechGrammarWordType',
    'SAFT8kHz8BitMono', 'DISPID_SVPause', 'ISpRecoGrammar2',
    'SFTInput', 'SREFalseRecognition', 'DISPID_SVEAudioLevel',
    'SPXMLRESULTOPTIONS', 'SGSExclusive', 'ISpeechPhraseInfo',
    'SpPhoneConverter', 'DISPID_SRSClsidEngine', 'SRCS_Disabled',
    'DISPID_SGRSRule', 'SPBO_AHEAD', 'DISPID_SPEActualConfidence',
    ...
    'SPSEMANTICERRORINFO', 'SpFileStream',
    'DISPID_SVSInputSentencePosition', 'SpeechRegistryUserRoot',
    'DISPID_SPRuleEngineConfidence', 'ISpeechAudioFormat',
    'SPPS_Function', 'SPPS_Interjection', 'SREStateChange',
    'DISPID_SGRSTsCount', 'DISPID_SRGDictationUnload',
    ...
    'DISPID_SpeechPhraseElements', 'SRAImport', 'SREPhraseStart',
    'ISpRecognizer2', 'DISPID_SPPChildren', 'SpMemoryStream',
    ...
    'SPPHRASEPROPERTY', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'WAVEFORMATEX', 'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE7',
    'DISPID_SASetState', 'DISPID_SLWs_NewEnum', 'SPAR_Medium',
    'SAFT44kHz16BitStereo', 'DISPID_SRGDictationSetState',
    'DISPID_SVVoice', 'SPPHRASERULE', 'DISPID_SRCBookmark',
    'SECFIgnoreKanaType', 'DISPID_SRProfile', 'SPEI_SR_RETAINEDAUDIO',
    'SP_VISEME_11', 'DISPID_SPRuleChildren', 'SDTAudio',
    ...
    'DISPID_SLPPhoneIds', 'SVP_19', 'DISPID_SRCreateRecoContext',
    'DISPID_SRCEventInterests', 'eLEXTYPE_PRIVATE15', 'SRSInactive',
    'DISPID_SpeechAudioStatus', 'DISPID_SRCEStartStream',
    'SP_VISEME_2', 'DISPID_SDKGetlongValue', 'SPEVENTENUM',
    'DISPID_SPEPronunciation', 'SAFT44kHz8BitStereo',
    'DISPID_SLWLangId', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SDKDeleteKey', 'SECFNoSpecialChars',
    'SpeechEngineProperties', 'ISpShortcut', 'SDTAll',
    'SPEI_HYPOTHESIS', 'DISPID_SGRSTransitions', 'SDTAlternates',
    'DISPID_SAEventHandle', 'SpInprocRecognizer',
    'eLEXTYPE_PRIVATE20', 'SVEBookmark', 'DISPID_SMSSetData',
    'SAFT12kHz8BitMono', 'SPSHT_OTHER', 'ISpRecoCategory', 'SDTRule',
    'SBONone', 'SVP_12', 'SAFT8kHz16BitMono', 'SpUnCompressedLexicon',
    'SPPS_SuppressWord', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SWFEBitsPerSample', 'SAFT48kHz8BitMono', 'SP_VISEME_0',
    'SPVOICESTATUS', 'SPDATAKEYLOCATION', 'SAFT11kHz16BitMono',
    'DISPID_SVEStreamEnd', 'DISPID_SRCEBookmark',
    'ISpeechPhraseRules', 'STSF_AppData', 'SPEI_START_SR_STREAM',
    'DISPID_SRCCmdMaxAlternates', 'SRERequestUI', 'SRTAutopause',
    'ISpRecognizer3', 'eLEXTYPE_USER', 'SPAS_RUN', 'SITooFast',
    'DISPID_SDKGetBinaryValue', '_SPAUDIOSTATE',
    'ISpeechTextSelectionInformation',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPCT_SUB_DICTATION',
    'DISPID_SRStatus', 'DISPID_SOTMatchesAttributes',
    'SDTLexicalForm', 'SSFMOpenReadWrite', 'SDA_Two_Trailing_Spaces',
    'DISPID_SRRSaveToMemory', 'SPRECOSTATE',
    'SpeechRetainedAudioOptions', 'IEnumString', 'SRTEmulated',
    'ISpeechObjectTokens', 'DISPID_SRRRecoContext',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRsAdd',
    'DISPID_SOTCDefault', 'DISPID_SRCEPhraseStart', 'SPGS_EXCLUSIVE',
    'SPWORDLIST', 'STSF_LocalAppData', 'SPSHT_EMAIL',
    'Speech_Max_Word_Length', 'DISPID_SPIAudioStreamPosition',
    'SPEI_MAX_SR', 'SRERecognition', 'eLEXTYPE_PRIVATE16',
    'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPRsCount', 'DISPID_SABufferNotifySize',
    'ISpPhoneConverter', 'DISPID_SPIGetDisplayAttributes',
    'SPEI_WORD_BOUNDARY', 'SPWORDPRONOUNCEABLE', 'SPDKL_CurrentUser',
    'DISPID_SLGetGenerationChange', 'DISPID_SPPEngineConfidence',
    'Speech_StreamPos_RealTime', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SBSFormat', 'SRTExtendableParse', 'ISpProperties',
    'DISPID_SPEsItem', 'SREInterference',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'STSF_CommonAppData',
    'SAFT48kHz16BitStereo', 'DISPID_SpeechAudio', 'SpeechRecoEvents',
    'DISPIDSPTSI', 'SPSHORTCUTPAIR', 'DISPID_SVSPhonemeId',
    'DISPID_SRGRules', 'SRSEDone', 'SpeechRuleState', 'SP_VISEME_13',
    'SLODynamic', 'SVEAudioLevel', 'SVP_14', 'SpeechAddRemoveWord',
    'SpeechPropertyResponseSpeed', 'SpMMAudioEnum', 'SPPS_RESERVED3',
    'SPAR_High', 'SPPS_Modifier', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPPId', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRIsUISupported', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPRDisplayAttributes',
    'SpeechDiscardType', 'DISPID_SPRNumberOfElements',
    'eLEXTYPE_PRIVATE5', 'DISPID_SGRSTsItem', 'SECFEmulateResult',
    'SPBO_PAUSE', 'SPRS_INACTIVE', 'SRTStandard',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SWFEFormatTag',
    'SAFT32kHz16BitStereo', 'SSTTWildcard', 'SRATopLevel',
    'DISPID_SRRGetXMLResult', 'SPEI_TTS_AUDIO_LEVEL', 'SVPAlert',
    'SPAS_CLOSED', 'DISPID_SPEsCount', 'SVSFIsXML',
    'SPAO_RETAIN_AUDIO', 'ISpStream', 'ISpeechMMSysAudio',
    'SP_VISEME_21', 'SAFTADPCM_11kHzStereo', 'DISPID_SOTSetId',
    'DISPID_SVRate', 'SpeechRunState', 'SPRECOCONTEXTSTATUS',
    'SPWORDPRONUNCIATIONLIST', 'SRSActiveAlways',
    'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE3',
    'SpTextSelectionInformation', 'SREBookmark', 'SP_VISEME_6',
    'DISPID_SRGCmdLoadFromResource', 'SPLEXICONTYPE',
    'DISPID_SRCEEnginePrivate', 'DISPID_SpeechDataKey',
    'SRERecoOtherContext', 'SVSFParseAutodetect', 'typelib_path',
    'DISPID_SGRClear', 'SP_VISEME_4', 'DISPID_SPISaveToMemory',
    'STCLocalServer', 'DISPID_SPIElements',
    'DISPID_SpeechCustomStream', 'SpeechPropertyResourceUsage',
    'SP_VISEME_3', 'SPEI_START_INPUT_STREAM', 'SSFMCreate',
    'SPPS_RESERVED4', 'SP_VISEME_16', 'ISpeechPhraseElements',
    'tagSTATSTG', 'SASStop', 'UINT_PTR',
    'DISPID_SpeechPhraseProperty', 'SPXRO_SML', 'eLEXTYPE_PRIVATE13',
    'SBOPause', 'SPPS_Unknown', 'DISPID_SRGDictationLoad',
    'SP_VISEME_10', 'DISPID_SMSALineId', 'eLEXTYPE_RESERVED8',
    'SpNotifyTranslator', 'DISPID_SRCERequestUI',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPCLangId', 'DISPID_SRGCommit', 'SPVPRIORITY',
    'SAFTCCITT_uLaw_11kHzMono', 'SITooLoud', 'SAFTGSM610_8kHzMono',
    'SPSNoun', 'SpeechPartOfSpeech', 'SPVPRI_OVER', 'DISPID_SGRId',
    'SVP_15', 'SECNormalConfidence', 'SRADefaultToActive',
    'SpeechDisplayAttributes', 'DISPID_SBSWrite', 'DISPID_SRRTimes',
    'SDA_No_Trailing_Space', 'DISPID_SPIReplacements',
    'SPEI_SR_AUDIO_LEVEL', 'SRAInterpreter', 'DISPID_SLGetWords',
    'SpeechCategoryPhoneConverters', 'ISpRecoContext2',
    'SpeechVoiceCategoryTTSRate', 'SP_VISEME_8', 'DISPID_SBSRead',
    'DISPID_SPRules_NewEnum', 'SGDisplay', 'DISPID_SPRuleName',
    'DISPID_SLPsItem', 'SVP_7', 'SPLO_DYNAMIC',
    'DISPIDSPTSI_SelectionOffset', 'SASPause', 'SPEI_SOUND_END',
    'DISPID_SPPValue', 'DISPID_SPEAudioTimeOffset',
    'ISpeechFileStream', 'SPAUDIOBUFFERINFO', 'SPPS_Noun',
    'DISPID_SPRuleId', 'SRAORetainAudio', 'SAFTGSM610_44kHzMono',
    'ISpAudio', 'DISPID_SRRTLength', 'DISPID_SVSLastResult',
    'SpMMAudioOut', 'Library', 'SPPROPERTYINFO', 'SVEPhoneme',
    ...
    'SRADynamic', 'DISPID_SLPSymbolic', 'SPGRAMMARWORDTYPE',
    'SpeechMicTraining', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SABIMinNotification', 'SSTTTextBuffer',
    'SECLowConfidence', 'IEnumSpObjectTokens', 'SP_VISEME_17',
    'DISPID_SPIStartTime', 'DISPID_SVSLastBookmark',
    'SpStreamFormatConverter', 'DISPID_SpeechObjectTokenCategory',
    'SPSInterjection', 'SPEVENT', 'SpeechTokenIdUserLexicon',
    'DISPID_SVAudioOutput', 'DISPID_SPEAudioStreamOffset',
    'SPSTREAMFORMATTYPE', 'DISPID_SPRFirstElement',
    'DISPID_SASNonBlockingIO', 'SREHypothesis', 'eLEXTYPE_MORPHOLOGY',
    'SVEEndInputStream', 'DISPID_SRCESoundEnd', 'SGRSTTDictation',
    'STCRemoteServer', 'DISPID_SLGetPronunciations',
    'DISPID_SRGSetTextSelection', 'SPINTERFERENCE_NONE',
    'DISPID_SRSSupportedLanguages', 'SLTUser',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechVoice',
    'SPRS_ACTIVE', 'SGRSTTWord', 'SpeechPropertyAdaptationOn',
    'SGSEnabled', 'DISPID_SOTsCount', 'SPEI_SENTENCE_BOUNDARY',
    'ISpeechPhraseInfoBuilder', 'SAFTCCITT_uLaw_8kHzStereo',
    'SREStreamStart', 'eLEXTYPE_VENDORLEXICON', 'SAFT24kHz8BitStereo',
    'SAFTCCITT_ALaw_11kHzMono', 'SpeechFormatType',
    'SpPhoneticAlphabetConverter', 'tagSPPROPERTYINFO',
    'DISPID_SGRsFindRule', 'DISPID_SOTCEnumerateTokens',
    'SDKLLocalMachine', 'SPWT_PRONUNCIATION', 'ISpeechPhraseProperty',
    'SPVISEMES', 'SpeechTokenContext', 'SLOStatic', 'SVP_8',
    'DISPID_SpeechVoiceEvent', 'SP_VISEME_20', 'STCInprocHandler',
    'SREPropertyStringChange', 'SPEI_ADAPTATION',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRRPhraseInfo',
    'DISPID_SVEViseme', 'DISPID_SpeechFileStream', 'SPEI_REQUEST_UI',
    'DISPID_SDKEnumValues', 'DISPID_SPELexicalForm',
    'DISPID_SGRSTPropertyId', 'SPSEMANTICFORMAT',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPIDSPTSI_ActiveLength',
    'SPSHT_Unknown', 'SpeechRuleAttributes', 'SPFILEMODE',
    'ISpeechCustomStream', 'SPCONTEXTSTATE', 'ISpeechAudio',
    ...
    'SSFMCreateForWrite', 'ISpLexicon', 'SPEI_RESERVED5',
    'SFTSREngine', 'SRSInactiveWithPurge', 'DISPID_SVSkip',
    'SRSEIsSpeaking', 'SpeechGrammarTagDictation',
    'DISPID_SpeechLexiconWord', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRCEHypothesis', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRCEFalseRecognition', 'SPRULESTATE', 'SGDSInactive',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVSInputWordLength',
    'ISpRecoContext', 'ISpeechAudioBufferInfo',
    'DISPID_SVSRunningState', 'SPEI_MIN_SR', 'DISPID_SPAs_NewEnum',
    'ISpeechRecoGrammar', 'SPAR_Low', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVEVoiceChange', 'SVSFParseSapi',
    'DISPID_SRSetPropertyNumber', 'SPBO_TIME_UNITS',
    ...
    'SAFT12kHz16BitStereo', 'SREPropertyNumChange',
    'DISPID_SLWsCount', 'DISPID_SRCEPropertyStringChange',
    'eLEXTYPE_RESERVED4', 'ISpeechVoice', 'DISPID_SVDisplayUI',
    'DISPIDSPTSI_SelectionLength', 'SECHighConfidence',
    'SpObjectTokenCategory', 'SPSNotOverriden', 'ISpRecognizer',
    'SPGS_DISABLED', 'DISPID_SASCurrentSeekPosition',
    '_ISpeechVoiceEvents', 'DISPID_SPPsItem',
    'DISPID_SRGetRecognizers', 'DISPID_SGRs_NewEnum',
    'SAFT11kHz8BitStereo', 'ISpRecoGrammar', 'SDTProperty',
    'DISPID_SVEWord', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SLWWord', 'SGLexical', 'SAFT22kHz8BitMono',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpNotifyTranslator',
    'DISPID_SAVolume', 'SAFT8kHz16BitStereo', 'DISPID_SOTs_NewEnum',
    'SpStream', 'DISPID_SRCRetainedAudioFormat', 'SAFT32kHz16BitMono',
    'DISPID_SBSSeek', 'ISpeechGrammarRuleState', 'SPSModifier',
    ...
    'DISPID_SRIsShared', 'SPPHRASEELEMENT', 'SpeechBookmarkOptions',
    'SVP_6', 'SpeechDictationTopicSpelling',
    'DISPID_SpeechGrammarRule', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SpeechXMLRecoResult', 'SPINTERFERENCE_TOOLOUD',
    'SpeechVisemeFeature', 'SSTTDictation', 'STCInprocServer',
    'SVSFParseSsml', 'DISPID_SABIEventBias',
    ...
    '__MIDL_IWinTypes_0009', 'ISpNotifySource',
    'DISPID_SRGIsPronounceable', 'SVP_3', 'DISPID_SPCPhoneToId',
    'DISPID_SVPriority', 'ISpObjectTokenCategory', 'DISPID_SPAsItem',
    'SpAudioFormat', 'SPSUnknown', 'DISPID_SpeechRecoContext',
    'ISpMMSysAudio', 'DISPID_SpeechPhraseBuilder', 'SPGS_ENABLED',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRRSetTextFeedback',
    'SAFT22kHz16BitMono', 'SPLOADOPTIONS', 'SpeechCategoryAudioIn',
    'SINoSignal', 'SAFT44kHz16BitMono', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCEEndStream', 'DISPID_SPPParent',
    'DISPID_SLAddPronunciation', 'DISPID_SRGReset', 'SP_VISEME_1',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SGRSTText', 'SpeechTokenKeyFiles',
    'DISPID_SRCERecognition', 'SPRECOGNIZERSTATUS',
    'SAFTADPCM_22kHzMono', 'DISPID_SOTDisplayUI',
    'eLEXTYPE_USER_SHORTCUT', 'SAFT16kHz16BitStereo', 'SpShortcut',
    'SpeechVoiceSkipTypeSentence', 'ISpEventSource', 'SPEI_RESERVED1',
    'SPSMF_SAPI_PROPERTIES', 'SVEVoiceChange', 'DISPID_SAFType',
    'DISPID_SRCCreateResultFromMemory',
    'ISpeechGrammarRuleStateTransition', 'eLEXTYPE_RESERVED7',
    'SVPOver', 'DISPID_SWFEExtraData', 'SpeechAudioVolume',
    ...
    'SAFT24kHz16BitStereo', 'SpMMAudioIn', 'SpResourceManager',
    'eWORDTYPE_ADDED', 'ISpeechWaveFormatEx', 'SPDKL_DefaultLocation',
    'DISPID_SpeechObjectToken', 'SPEI_RECO_OTHER_CONTEXT',
    'SVF_Emphasis', 'ISpXMLRecoResult', 'eWORDTYPE_DELETED',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT12kHz16BitMono',
    'SpeechStreamFileMode', 'SPSMF_UPS', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPARecoResult', 'SVSFUnusedFlags', 'SPPHRASEREPLACEMENT',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SVEBookmark', 'DISPID_SGRSTWeight', 'SPBO_NONE',
    'SPRST_NUM_STATES', 'DISPID_SRSetPropertyString',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechLexiconWords',
    'SPEI_INTERFERENCE', 'DISPID_SLPs_NewEnum', 'SPVPRI_NORMAL',
    'SPRECORESULTTIMES', 'DISPID_SpeechPhraseInfo', 'SITooQuiet',
    'DISPID_SDKEnumKeys', 'SVP_9', 'DISPID_SWFESamplesPerSec',
    'SECFDefault', 'SpVoice', 'SP_VISEME_15', 'DISPID_SpeechLexicon',
    'DISPID_SpeechPhraseRule', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPWORDTYPE', 'SpeechAllElements', 'SVSFParseMask',
    'SPAUDIOOPTIONS', 'SPPS_LMA', 'DISPID_SLPType', 'SRESoundEnd',
    'SREPrivate', 'SpeechVoicePriority', 'DISPID_SPPsCount',
    'ISpeechRecoResult', 'DISPID_SGRsDynamic',
    'ISpeechLexiconPronunciations',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRGRecoContext'
]

_check_version('1.4.1', 1722231308.563851)
